...
![Example slides animation](example-slides.gif)
...
The `tests/regresion/` directory contains individual `.qmd` files that demonstrate specific features. Each file can be rendered independently with:
